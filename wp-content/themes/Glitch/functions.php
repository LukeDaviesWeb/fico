...
function enqueue_style() {
    ...
    //added global script
    wp_enqueue_style( 'main-style', get_template_directory_uri() . '/build/css/global.css', null, time() );

    //added template specific stylesheets
    ...
    //run gulp style to merge all all the stylesheets into build/bundle.css 
    // wp_enqueue_style( 'main-style', get_template_directory_uri() . '/build/css/bundle.css', null, time() );

    //////////////////////////////////////////////////////////////////////////

    // //required scripts
    // wp_enqueue_script( 'min-script', get_template_directory_uri() . '/script-min.js', array('jquery'), time(), true);
    wp_enqueue_script( 'main-style', get_template_directory_uri() . '/build/js/script.js', null, time() );
}
